...
def convert_hymotion_to_rfgenesis_format(
    ...
    """
    Convert HY-Motion output to RF-Genesis compatible SMPL-24 format.

    HY-Motion outputs SMPL-H parameters (52 joints) that must be converted to
    standard SMPL (24 joints) for RF-Genesis SMPL_Layer. Only 22 body joints
    are used; L_Hand/R_Hand are set to identity rotation.
